...
import com.app.nbm.adapter.PassengerAdapter;
...
public class PassengerListActivity extends AppCompatActivity {
    ...
    private String TAG = PassengerListActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContext = PassengerListActivity.this;
        ...
        mAdapter = new PassengerAdapter(mContext, albumList);
